...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--raw_annotation_path", type=str, default="data/annotation_191-task_1k.json"
    )
    parser.add_argument(
        "--new_annotation_save_path",
        type=str,
        default="data/annotation_191-task_1k_add_idx.json",
    )
    parser.add_argument(
        "--text_data_save_path", type=str, default="data/text_data_visionflan.json"
    )
